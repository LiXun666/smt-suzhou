    ...
    $("#main").droppable({
        ...
        drop:function (event , ui) {
            ...
            switch (name) {
                case "node1":
                    var id = guid();
                    $(this).append('<div class="node" style="position: absolute ; border-radius:6px; border: 0px solid #346789; width: 100px; height: 80px ; text-align: center" id="' + id + '" >' + $(ui.helper).html() + '</div>');
...
//鼠标进入增加一个删除的小图标
    $("#main").on("mouseenter", ".node", function () {
        ...
        var delpicture = $(this).append('<img src="/newjsplumb/images/clone2.png"  style="margin-top: -160px; margin-right: -60px" id="dletimg1"/>');
...
//双击节点内容区域时的事件
    function doubleclick(id) {
        $(id).dblclick(function () {
            ...
            var imgClick = $(this).find("img").attr("onclick");
            $(this).html("");
